    ...
    <main>
        ...
        <div class="localcuisine">
          ...
          <div class = explanation>
            <p>「鶏飯」は、ほぐした鶏肉、干ししいたけ、錦糸卵、パパイヤの味噌漬け、みかんの皮などを、<br class="pc">白いごはんの上にのせ、鶏ガラのスープをかけて食べる、奄美地域を代表する郷土料理。</p>
          </div>
        ...
        <div class="localcuisine">
          ...
          <div class = explanation>
            <p>
              鹿児島県の特産品であるブリと大根を使った「ぶり大根」は冬の定番料理として親しまれている。<br class="pc">
