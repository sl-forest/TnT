      ...
      <h1>霧島神宮</h1>
        ...
        <div class="TouristSpot">
            ...
            <div class = TouristSpot_note>    
              ...
              <dl>
                <dt>住所</dt>
                <dd>鹿児島県霧島市霧島田口2608-5</dd>
              </dl>

              <dl>
                <dt>移動方法</dt>
                <dd>【電車・バス】JR日豊本線「霧島神宮」駅より、霧島いわさきホテル行きバスで約15分、「霧島神宮」バス停下車すぐ
                    <br>
              ...
              <dl>
                <dt>詳しく</dt>
                <dd><a href="https://kirishimajingu.or.jp/">霧島神宮 公式ページ</a></dd>
              </dl>
              <a href = "https://travel.rakuten.co.jp/yado/spot/kagoshima/S46000257.html" class = "btn">霧島神宮 周辺のホテル・旅館</a>
